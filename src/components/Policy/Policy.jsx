...
const Policy = () => {
  return (
    <section>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Aprycote.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Aprycote, accessible from{' '}
            <a
              href="https://aprycote-food-app.vercel.app/"
      ...
      <ul>
        <li>
          <p>By email: ejicyrilarinze@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href="https://aprycote-food-app.vercel.app/policy"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://aprycote-food-app.vercel.app/policy
            </a>
          </p>
        </li>
      </ul>
